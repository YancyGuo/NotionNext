...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Yancy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个希望能摸一辈子🐟的程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.yancyai.xyz/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Yancy, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，我是一个打工人,Hi，我是一个干饭人,Hi，我是超级摸鱼王,欢迎来到我的博客🎉,本站大部分文章由 AI 润色输出，请注意甄别',
